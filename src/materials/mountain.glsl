...
#define SHADER_NAME Mountain
#define STANDARD 
#define SIXTY_ENVMAP 1
#define SIXTY_NORMALMAP 1
#define USE_UV 1
#define SIXTY_NORMALMAP_UV uv
#define SIXTY_MAP_UV uv
#define SIXTY_ARMMAP_UV uv
#define SIXTY_MAP 1
#define SIXTY_ARMMAP 1
#define SIXTY_MAP2 1
#define SIXTY_MAP2_UV uv
#define SIXTY_MIXMAP 1
#define USE_MAP
#define USE_ENVMAP
...
void main() {
    ...
    float alpha = mix(1., smoothstep(302., 301.5, vViewPosition.z), fortEnergy);
    /* backsides */
